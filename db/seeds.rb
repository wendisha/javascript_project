...
Player.create(user_id: 1, name: "Messi", country_of_origin: "Argentina", position: "Att Mid")
Player.create(user_id: 1, name: "C Ronaldo", country_of_origin: "Portugal", position: "Att Mid")
